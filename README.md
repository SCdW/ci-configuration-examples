...
|:---------------------------|:-----------------:|:----------------------------:|:--------------------------:|
[![MATLAB](https://github.com/SCdW/ci-configuration-examples/actions/workflows/ci.yml/badge.svg)](https://github.com/SCdW/ci-configuration-examples/actions/workflows/ci.yml)
